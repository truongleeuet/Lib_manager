								...
								<form name="formEditBook" action="controler" method="get">
									<table width="95%" border="0" align="center">
										...
										<tr>
											...
											<td><input name="book.domain" type="text"
												id="book.domain" size="35"
												value="<%=book1.getCategories()%>" /></td>
											<td>&nbsp;</td>
										</tr>
										<tr>
											<td><p>
											...
											<td><input name="book.authors" type="text"
												id="book.authors" size="35" value="<%=book1.getAuthors()%>" /></td>
											<td>&nbsp;</td>
										</tr>
										<tr>
											<td><p>
											...
											<td><input name="book.publisher" type="text"
												id="book.publisher" size="35"
												value=<%=book1.getPublisher()%> /></td>
											<td>&nbsp;</td>
										</tr>
										<tr>
											<td><p>
										...
										<tr>
											...
											<td><input name="book.amount" type="text"
												id="book.amount" size="35" value="<%=book1.getAmount()%>" /></td>
											<td>&nbsp;</td>
										</tr>
										<tr>
											<td><p>
											...
											<td><input name="book.images" type="text"
												id="book.images" size="35" value="<%=book1.getImages()%>" /></td>
											<td>&nbsp;</td>
										</tr>
										<tr>
											<td valign="top"><p>
											...
											<td><textarea name="book.description"
													id="book.description" cols="35" rows="5"><%=book1.getDescription()%></textarea></td>
											<td>&nbsp;</td>
										</tr>
										<tr>
											<td>&nbsp;</td>
										...
										<tr>
											...
											<td><div align="center">
													...
													<input name="book.submit" type="submit" id="book.submit"
														value="Save" /> <input name="book.reset" type="reset"
														id="book.reset" />
												</div></td>
											<td>&nbsp;</td>
										</tr>
