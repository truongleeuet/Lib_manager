					...
					<tr valign="top">
						...
						<td rowspan="2">
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr valign="top">
									<td width="45%">
										<p class="style1">Tên đăng nhập của bạn đọc cần cập nhật:
										</p>
										<form action="controler" method="get" name="formDeletePatron">
											<table width="95%" border="0">
												...
												<tr>
													...
													<td><input name="update.userName" type="text"
														id="update.userName" size="35" /></td>
													<td>&nbsp;</td>
												</tr>
												<tr>
													<td>&nbsp;</td>
													<td><div align="center">
															...
															<input name="update.submit" type="submit"
																id="update.submit" />
														</div></td>
													<td>&nbsp;</td>
												</tr>
